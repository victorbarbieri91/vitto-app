...
export const TransactionCompactItem: React.FC<TransactionCompactItemProps> = ({
  ...
  onEditTransaction,
  onDeleteTransaction,
  onConfirmFixedTransaction: _onConfirmFixedTransaction,
  onPartialFixedTransaction: _onPartialFixedTransaction,
  onUndoFixedTransaction,
  onEditFixedTransaction: _onEditFixedTransaction,
  onDeleteInvoice,
  onActivateTransaction: _onActivateTransaction,
  onInvoiceClick,
  onEfetivar,
